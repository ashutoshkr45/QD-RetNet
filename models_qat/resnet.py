...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, heatmap=False, feature_extracting=False, dropout_p=0.5):
        self.inplanes = 64
        ...
        self.last_linear = nn.Linear(num_classes, 11)
