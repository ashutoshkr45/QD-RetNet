...
def parse_args():
    ...
    parser.add_argument("--model_configs", type=str, default='config_oct.py',
                        help="filename of the model configuration file.")
    parser.add_argument("--model_id", default="s2", type=str, help="to make unique path for saving model")
