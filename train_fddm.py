...
import importlib
import numpy as np
from models import save_model, load_separate_model_I
...
def parse_args():
    ...
    parser.add_argument("--print_freq", default=30, type=int, help="print frequent (default: 20)")
    parser.add_argument("--model_configs", type=str, default='config.py',
                        help="filename of the model configuration file.")
    parser.add_argument("--model_id", default="m1", type=str, help="to make unique path for saving model")
...
def main(opts):
    ...
    model_f, model_o = load_separate_model_I(configs, device, checkpoint)
